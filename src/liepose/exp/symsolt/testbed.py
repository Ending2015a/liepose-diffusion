...
from liepose.data.symsolt.dataset import TestDataset, TrainDataset
from liepose.data.symsolt.evaluator import Evaluator
...
class Testbed(BaseTestbed):
  ...
  def create_test_dataset(self):
    return TestDataset(
      ...
      shape_names=self.a.shape_names,
      color_mode=self.a.color_mode,
      include_equivalents=True,
      pad_equivalents=True,
    )
