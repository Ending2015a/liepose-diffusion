...
def as_lie(t) -> SE3:
  ...
  if is_vec(t):
    return SE3(t)
  if is_vec9d(t):
    return SE3.from_matrix(as_mat(t))
...
def geodesic2_distance(x1, x2, w=1.0):
  x1 = as_lie(x1)
  x2 = as_lie(x2)
  dff = x2 @ x1.inverse()
...
def decouple_distance(x1, x2, w=1.0):
  x1 = as_tan(x1)
  x2 = as_tan(x2)
  t1 = x1[:3]
  t2 = x2[:3]
  ...
  r1 = x1.rotation()
  r2 = x2.rotation()
  dist = so3_distance_dict["geodesic"](r1, r2)
...
distance_dict = {
  ...
  "geodesic2": geodesic2_distance,  # geo(RT)
  "decouple": decouple_distance,
